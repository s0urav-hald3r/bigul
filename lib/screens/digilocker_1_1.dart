...
class DigiLocker11 extends StatefulWidget {
  const DigiLocker11({Key? key}) : super(key: key);

  @override
  State<DigiLocker11> createState() => _DigiLocker11State();
}

class _DigiLocker11State extends State<DigiLocker11> {
  void allowAccess() {
    showDialog(
        context: context,
